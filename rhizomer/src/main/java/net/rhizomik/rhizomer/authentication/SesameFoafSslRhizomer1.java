 ...
 */
public class SesameFoafSslRhizomer1 extends FoafSslVerifier {
    ...
    static final transient Logger log = Logger.getLogger(SesameFoafSslRhizomer1.class.getName());
    ...
    public boolean verify(WebIdClaim webid) {
        ...
        try {
            ...
            Logger.getLogger(SesameFoafSslRhizomer1.class.getName()).log(Level.SEVERE, null, ex);
        }
        //SailRepositoryConnection rep = cache.fetch();
        if (rep == null) {
            return false;
        }
    ...
    public RepositoryConnection conectarFitxerRdf() throws RepositoryException {
        String cadenaRuta = "file:/home/marc/NetBeansProjects/rhizomer/src/main/webapp/WEB-INF/usuaris.rdf";
